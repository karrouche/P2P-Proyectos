...
_MENU()
{
        ...
        echo
        echo
        echo "1) Instalar Servicio Pydio."
        echo "2) Crear base de datos para Pydio."
        echo "3) Solucionar error de instalacion Pydio"
        echo "4) Salir."
...
do
        case $opc in
                ...
                2)  read -p "Indique el nombre de la base de datos: " var1
